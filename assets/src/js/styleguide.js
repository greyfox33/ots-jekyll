! function e(t, n, r) {
    ...
    1: [function(e, t, n) {
        var r = e("jquery"),
            i = function(e) {
                ...
                var i = parseInt(r(".sidenav").css("padding-top"), 10),
                    o = parseInt(t.css("padding-top"), 10);
                return n = r(".site-nav-secondary").first().outerHeight(), n -= o - i, t.offset().top - n
            };
        t.exports = i
    }, {
        jquery: 5
    ...
    3: [function(e, t, n) {
        var r = e("jquery"),
            i = (e("./calculate-anchor-position"), r(".js-sticky-nav")),
            o = r(".site-header"),
            s = o.outerHeight(!0),
            a = "is-scrolled",
            u = 850;
        t.exports = function(e) {
            if (0 !== i.length && 0 !== o.length) {
                ...
                var t = i.outerHeight(!0),
                    ...
                    l = n + t;
                window.innerWidth > u && l > s ? (i.addClass(a), o.addClass(a), r(".usa-banner").addClass(a), r(".site-header-navbar").addClass(a), r(".site-nav-secondary").addClass(a), r(".sidenav").addClass(a), r(".main-content").addClass(a), r("body").css("paddingTop", s)) : (i.removeClass(a), o.removeClass(a), r(".usa-banner").removeClass(a), r(".site-header-navbar").removeClass(a), r(".site-nav-secondary").removeClass(a), r(".sidenav").removeClass(a), r(".main-content").removeClass(a), r("body").css("paddingTop", 0))
            }
        }
    }, {
        "./calculate-anchor-position": 1,
    ...
    4: [function(e, t, n) {
        ...
        var o = e("./components/calculate-anchor-position"),
            s = e("./components/sticky-nav");
        $(function() {
            setTimeout(function() {
                e("./components/scroll-to-top-for-hash")
            }, 150)
        }), $(".sidenav").on("keydown", "a", function(e) {
            var t = 13;
            e.which === t && $(this).data("keypress", !0)
        }), $(".sidenav").on("click", "a", function(e) {
            var t = $(this).attr("href").split("#")[1],
                n = o(t);
            return 0 === n || (e.preventDefault(), void $("body,html").animate({
                scrollTop: n
            }, {
                duration: 200,
                start: function() {
                    ...
                    var n = $(e.target),
                        r = $("#" + t);
                    n.data("keypress") === !0 && (n.removeData("keypress"), r.attr("tabindex", "-1"), r.focus())
                }
            }))
        }), $(".preview-search-bar .usa-search").submit(function(e) {
            e.preventDefault()
        }), $(window).on("scroll", i), $(window).on("resize", r), s()
    }, {
        "./components/calculate-anchor-position": 1,
        "./components/scroll-to-top-for-hash": 2,
        "./components/sticky-nav": 3,
        jquery: 5
    }],
    5: [function(e, t, n) {
        ! function(e, n) {
            ...
            function T(e, t, n, r) {
                ...
                if (d && (i = p(t, e[0].ownerDocument, !1, e, r), o = i.firstChild, 1 === i.childNodes.length && (i = o), o || r)) {
                    ...
                    if (a)
                        for (l = s[s.length - 1].ownerDocument, oe.map(s, x), f = 0; f < a; f++) u = s[f], Fe.test(u.type || "") && !Ee.access(u, "globalEval") && oe.contains(l, u) && (u.src ? oe._evalUrl && oe._evalUrl(u.src) : oe.globalEval(u.textContent.replace(Xe, "")))
                }
                return e
            }
            ...
            function P(e, t, n) {
                for (var r, i = ($.tweeners[t] || []).concat($.tweeners["*"]), o = 0, s = i.length; o < s; o++)
            ...
            function $(e, t, n) {
                ...
                for (M(c, l.opts.specialEasing); o < s; o++)
                    if (r = $.prefilters[o].call(l, e, c, l.opts)) return oe.isFunction(r.stop) && (oe._queueHooks(l.elem, l.opts.queue).stop = oe.proxy(r.stop, r)), r;
            ...
            var ce = function(e) {
                function t(e, t, n, r) {
                    ...
                    if (!r && ((t ? t.ownerDocument || t : I) !== L && q(t), t = t || L, O)) {
                        if (11 !== g && (l = me.exec(e)))
                            if (i = l[1]) {
                                if (9 === g) {
                        ...
                        if (w.qsa && !X[e + " "] && (!F || !F.test(e))) {
                            if (1 !== g) h = t, d = e;
                                ...
                                for ((a = t.getAttribute("id")) ? a = a.replace(xe, "\\$&") : t.setAttribute("id", a = $), f = E(e), o = f.length, u = pe.test(a) ? "#" + a : "[id='" + a + "']"; o--;) f[o] = u + " " + p(f[o]);
                ...
                function d(e, t, n) {
                    ...
                    return t.first ? function(t, n, o) {
                        ...
                        if (s) {
                            ...
                            for (; t = t[r];)
                                if (1 === t.nodeType || i) {
                                    if (l = t[$] || (t[$] = {}), u = l[t.uniqueID] || (l[t.uniqueID] = {}), (a = u[r]) && a[0] === W && a[1] === o) return c[2] = a[2];
                ...
                function m(e, t, n, i, o, s) {
                    return i && !i[$] && (i = m(i)), o && !o[$] && (o = m(o, s)), r(function(r, s, a, u) {
                        var l, c, f, p = [],
                            d = [],
                            h = s.length,
                ...
                var b, w, T, C, k, E, N, S, j, D, A, q, L, H, O, F, P, R, M, $ = "sizzle" + 1 * new Date,
                    I = e.document,
                    W = 0,
                    B = 0,
                    _ = n(),
                ...
                w = t.support = {}, k = t.isXML = function(e) {
                    ...
                    return r !== L && 9 === r.nodeType && r.documentElement ? (L = r, H = L.documentElement, O = !k(L), (n = L.defaultView) && n.top !== n && (n.addEventListener ? n.addEventListener("unload", Te, !1) : n.attachEvent && n.attachEvent("onunload", Te)), w.attributes = i(function(e) {
                        ...
                        return n ? n : (n = (e.ownerDocument || e) === (t.ownerDocument || t) ? e.compareDocumentPosition(t) : 1, 1 & n || !w.sortDetached && t.compareDocumentPosition(e) === n ? e === L || e.ownerDocument === I && M(I, e) ? -1 : t === L || t.ownerDocument === I && M(I, t) ? 1 : D ? ee(D, e) - ee(D, t) : 0 : 4 & n ? -1 : 1)
                    } : function(e, t) {
                        if (e === t) return A = !0, 0;
                        var n, r = 0,
                            i = e.parentNode,
                    ...
                    if ((e.ownerDocument || e) !== L && q(e), n = n.replace(ce, "='$1']"), w.matchesSelector && O && !X[n + " "] && (!P || !P.test(n)) && (!F || !F.test(n))) try {
                        var r = R.call(e, n);
                            ...
                            return 1 === r && 0 === i ? function(e) {
                                ...
                                if (v) {
                                    ...
                                    if (h = [s ? v.firstChild : v.lastChild], s && y) {
                                        for (p = v, f = p[$] || (p[$] = {}), c = f[p.uniqueID] || (f[p.uniqueID] = {}), l = c[e] || [], d = l[0] === W && l[1], x = d && l[2], p = d && v.childNodes[d]; p = ++d && p && p[g] || (x = d = 0) || h.pop();)
                                            if (1 === p.nodeType && ++x && p === t) {
                                                c[e] = [W, d, x];
                                                break
                                            }
                                    } else if (y && (p = t, f = p[$] || (p[$] = {}), c = f[p.uniqueID] || (f[p.uniqueID] = {}), l = c[e] || [], d = l[0] === W && l[1], x = d), x === !1)
                                        for (;
                                            (p = ++d && p && p[g] || (x = d = 0) || h.pop()) && ((a ? p.nodeName.toLowerCase() !== m : 1 !== p.nodeType) || !++x || (y && (f = p[$] || (p[$] = {}), c = f[p.uniqueID] || (f[p.uniqueID] = {}), c[e] = [W, x]), p !== t)););
            ...
            oe.event = {
                ...
                fix: function(e) {
                    ...
                    var t, n, r, i = e.type,
                        o = e,
                        s = this.fixHooks[i];
                    for (s || (this.fixHooks[i] = s = $e.test(i) ? this.mouseHooks : Me.test(i) ? this.keyHooks : {}), r = s.props ? this.props.concat(s.props) : this.props, e = new oe.Event(o), t = r.length; t--;) n = r[t], e[n] = o[n];
            ...
            jt.href = vt.href, oe.extend({
                ...
                ajax: function(t, n) {
                    function r(t, n, r, a) {
                        var l, f, y, x, w, C = n;
                        2 !== b && (b = 2, u && e.clearTimeout(u), i = void 0, s = a || "", T.readyState = t > 0 ? 4 : 0, l = t >= 200 && t < 300 || 304 === t, r && (x = z(p, T, r)), x = X(p, x, T, l), l ? (p.ifModified && (w = T.getResponseHeader("Last-Modified"), w && (oe.lastModified[o] = w), w = T.getResponseHeader("etag"), w && (oe.etag[o] = w)), 204 === t || "HEAD" === p.type ? C = "nocontent" : 304 === t ? C = "notmodified" : (C = x.state, f = x.data, y = x.error, l = !y)) : (y = C, !t && C || (C = "error", t < 0 && (t = 0))), T.status = t, T.statusText = (n || C) + "", l ? g.resolveWith(d, [f, C, T]) : g.rejectWith(d, [T, C, y]), T.statusCode(m), m = void 0, c && h.trigger(l ? "ajaxSuccess" : "ajaxError", [T, p, l ? f : y]), v.fireWith(d, [T, C]), c && (h.trigger("ajaxComplete", [T, p]), --oe.active || oe.event.trigger("ajaxStop")))
                    }
            ...
            return oe.noConflict = function(t) {
                return e.$ === oe && (e.$ = It), t && e.jQuery === oe && (e.jQuery = $t), oe
            }, t || (e.jQuery = e.$ = oe), oe
        })
    }, {}]
}, {}, [4]);